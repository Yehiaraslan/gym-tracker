      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 40 }}>
        ...
        <View style={{ flexDirection: 'row', paddingHorizontal: 16, gap: 8, marginBottom: 16 }}>
          <View style={{ flex: 1, backgroundColor: colors.surface, borderRadius: 12, padding: 16, alignItems: 'center' }}>
            <Text style={{ color: colors.cardMuted, fontSize: 12 }}>Current</Text>
            <Text style={{ color: colors.cardForeground, fontSize: 28, fontWeight: '700' }}>
              {latestWeight > 0 ? `${latestWeight}` : '—'}
            </Text>
            <Text style={{ color: colors.cardMuted, fontSize: 12 }}>kg</Text>
          </View>
          <View style={{ flex: 1, backgroundColor: colors.surface, borderRadius: 12, padding: 16, alignItems: 'center' }}>
            <Text style={{ color: colors.cardMuted, fontSize: 12 }}>7-Day Change</Text>
            <Text style={{
              color: weekChange > 0 ? '#F59E0B' : weekChange < 0 ? '#22C55E' : colors.cardMuted,
              fontSize: 28,
              fontWeight: '700',
            }}>
        ...
        {recentEntries.length > 1 && (
          <View style={{ marginHorizontal: 16, backgroundColor: colors.surface, borderRadius: 14, padding: 16, marginBottom: 16 }}>
            <Text style={{ color: colors.cardForeground, fontSize: 16, fontWeight: '700', marginBottom: 12 }}>
        ...
        <View style={{ marginHorizontal: 16, backgroundColor: colors.surface, borderRadius: 16, padding: 20, marginBottom: 16 }}>
          ...
          <View style={{ flexDirection: 'row', gap: 12, marginBottom: 12 }}>
            <View style={{ flex: 1 }}>
              <Text style={{ color: colors.cardMuted, fontSize: 12, marginBottom: 4 }}>Weight (kg) *</Text>
              <TextInput
                value={weight}
            ...
            <View style={{ flex: 1 }}>
              <Text style={{ color: colors.cardMuted, fontSize: 12, marginBottom: 4 }}>Body Fat %</Text>
              <TextInput
                value={bodyFat}
          ...
          <View style={{ flexDirection: 'row', gap: 12, marginBottom: 12 }}>
            <View style={{ flex: 1 }}>
              <Text style={{ color: colors.cardMuted, fontSize: 12, marginBottom: 4 }}>Chest (cm)</Text>
              <TextInput
                value={chest}
            ...
            <View style={{ flex: 1 }}>
              <Text style={{ color: colors.cardMuted, fontSize: 12, marginBottom: 4 }}>Waist (cm)</Text>
              <TextInput
                value={waist}
          ...
          <View style={{ flexDirection: 'row', gap: 12, marginBottom: 12 }}>
            <View style={{ flex: 1 }}>
              <Text style={{ color: colors.cardMuted, fontSize: 12, marginBottom: 4 }}>Arms (cm)</Text>
              <TextInput
                value={arms}
            ...
            <View style={{ flex: 1 }}>
              <Text style={{ color: colors.cardMuted, fontSize: 12, marginBottom: 4 }}>Thighs (cm)</Text>
              <TextInput
                value={thighs}
