...
const en = {
  ...
  homeWaitingCoachTitle: 'Waiting for {name}\u2019s plan',
  homeWaitingCoachBody: 'Your workouts and meals will appear here as soon as your coach sends them. Nothing is scheduled until then.',
  homeWaitingCoachCta: 'Message your coach',
  homeNoCoachTitle: 'Link to your coach to get your plan',
  homeNoCoachBody: 'MY Lifestyle has no built-in programme. Enter the invite code from Coach Mohamad on the Coach tab and your workouts and meals will appear here.',
  homeNoCoachCta: 'Enter invite code',
...
const ar: typeof en = {
  ...
  homeWaitingCoachTitle: 'في انتظار خطة {name}',
  homeWaitingCoachBody: 'ستظهر تمارينك ووجباتك هنا فور أن يرسلها مدربك. لا يوجد جدول حتى ذلك الحين.',
  homeWaitingCoachCta: 'راسل مدربك',
  homeNoCoachTitle: 'اربط حسابك بمدربك لتستلم خطتك',
  homeNoCoachBody: 'لا يوجد برنامج افتراضي في التطبيق. أدخل كود الدعوة من الكابتن محمد في تبويب المدرب وستظهر تمارينك ووجباتك هنا.',
  homeNoCoachCta: 'أدخل كود الدعوة',
